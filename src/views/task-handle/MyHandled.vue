...
export default class MyHandled extends Vue {
    ...
    handleTableChange(pagination?, filters?, sorter?) {
        ...
        this.isLoading = true;
        this.$common.post('ExtenalApi/GetMyHandledTasksDataTable', {
            currentPage: (pagination || this.pagination).current || 1,
